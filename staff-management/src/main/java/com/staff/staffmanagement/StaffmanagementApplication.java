...
public class StaffmanagementApplication {
	...
	private void addStaffExample(PositionService positionService, StaffService staffService, ShiftsService shiftsService, PositionMapper positionMapper, StaffMapper staffMapper, ShiftsMapper shiftsMapper) {
		...
		System.out.println("Position Saved: "+ responsePositionManager);
		...
		System.out.println("Position Saved: "+ responsePositionCashier1);
		...
		System.out.println("Position Saved: "+ responsePositionJanitor1);
		...
		System.out.println("Position Saved: "+ responsePositionJanitor2);
		...
		System.out.println("Position Saved: "+ responsePositionJanitor3);
		...
		System.out.println("Shift Saved: "+ responseShift1);
		...
		System.out.println("Shift Saved: "+ responseShift2);
		...
		System.out.println("Shift Saved: "+ responseShift3);
		...
		System.out.println("Shift Saved: "+ responseShift4);
		...
		System.out.println("Shift Saved: "+ responseShift5);
		...
		System.out.println("Shift Saved: "+ responseShift6);
		...
		System.out.println("Staff Saved: "+ responseStaffManager);
		...
		System.out.println("Staff Saved: "+ responseStaffCashier1);
		...
		System.out.println("Staff Saved: "+ responseStaffCashier2);
		...
		System.out.println("Staff Saved: "+ responseStaffJanitor1);
		...
		System.out.println("Staff Saved: "+ responseStaffJanitor2);
		...
		System.out.println("Staff Saved: "+ responseStaffJanitor3);
